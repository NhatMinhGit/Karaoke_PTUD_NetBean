 ...
 */
public class GUIThongKeDoanhThuTheoKhachHang extends javax.swing.JFrame {

    /**
     * Creates new form GUIThongKeDoanhThu
     */
    public GUIThongKeDoanhThuTheoKhachHang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIThongKeDoanhThuTheoKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIThongKeDoanhThuTheoKhachHang().setVisible(true);
            }
        });
    }
